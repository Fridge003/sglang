...
| **GLM-5** (744B MoE, DSA)          | `zai-org/GLM-5`                                   | Zhipu AI's GLM-5: 744B-parameter MoE model (40B active) with DeepSeek Sparse Attention (DSA) and multi-token prediction; shares DeepSeek-V3/V3.2 architecture. [See GLM-5 usage guide](../basic_usage/glm5.md) |
