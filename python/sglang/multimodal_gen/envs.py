...
if TYPE_CHECKING:
    ...
    SGLANG_DIFFUSION_LTX2_INJECT_CONNECTOR_OUTPUT: str | None = None
    SGLANG_DIFFUSION_LTX2_INJECT_STAGE1_OUTPUT: str | None = None
    SGLANG_DIFFUSION_LTX2_INJECT_STAGE2_OUTPUT: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "SGLANG_DIFFUSION_LTX2_INJECT_CONNECTOR_OUTPUT": _lazy_path(
        "SGLANG_DIFFUSION_LTX2_INJECT_CONNECTOR_OUTPUT"
    ),
    "SGLANG_DIFFUSION_LTX2_INJECT_STAGE1_OUTPUT": _lazy_path(
        "SGLANG_DIFFUSION_LTX2_INJECT_STAGE1_OUTPUT"
    ),
    "SGLANG_DIFFUSION_LTX2_INJECT_STAGE2_OUTPUT": _lazy_path(
        "SGLANG_DIFFUSION_LTX2_INJECT_STAGE2_OUTPUT"
    ),
    "SGLANG_DIFFUSION_LTX2_INJECT_UPSAMPLE_OUTPUT": _lazy_path(
        "SGLANG_DIFFUSION_LTX2_INJECT_UPSAMPLE_OUTPUT"
    ),
    "SGLANG_DIFFUSION_LTX2_INJECT_STAGE2_NOISED_INPUT": _lazy_path(
